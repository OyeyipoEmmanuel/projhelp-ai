...
const LandingPg = () => {
    ...
    return (
        <main className="relative flex flex-col items-center justify-between space-y-4 px-4 pt-6 md:flex-row md:space-y-0 md:space-x-6 md:py-24">
            {/* Spinning square */} 
            <div className="absolute w-20 h-20 top-[10%] md:left-[50%] right-12">
                <section className=" w-18 h-18 border border-purple-400 rounded-md  animate-spin [animation-duration:8s]"></section>
            </div>
            <section className="w-full md:w-[50%] md:flex md:flex-col md:space-y-6">
                ...
                <div className="mt-3 flex flex-col justify-center space-y-1 md:space-y-0 md:space-x-3 md:justify-start md:flex-row">
                    <span className="flex flex-row items-center space-x-1">
                        <div className="w-2 h-2 bg-green-500 rounded-full "></div>
                        <p className="text-black/70 text-[15px]">No Login Required</p>
                    </span>

                    <span className="flex flex-row items-center space-x-1 justify-end">
                        <div className="w-2 h-2 bg-green-500 rounded-full "></div>
            ...
            <section className="w-full bg-white shadow-xl mb-2 rounded-xl md:w-[45%]">
                <img src={landingPgImg} alt="projhelp-ai" className="p-5 rounded-4xl " loading="eager" fetchPriority="high" />
            </section>
        </main>
    )
}
